...
const form = reactive<BancoFormData>({ ...props.initialData });

// Editing an existing banco swaps initialData after the store loads it.
watch(
  () => props.initialData,
...
<template>
  ...
  >
    ...
    <div class="flex justify-end gap-3 sm:col-span-2">
      ...
      >
        {{ isSaving ? t('master.bancos.form.saving') : submitLabel }}
      </button>
    </div>
  </form>
</template>
